...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1000, 'input_size': (2, 64, 1024), 'pool_size': None,
...
class T2T_module(nn.Module):
    ...
    """
    def __init__(self, img_size=[64,1024], tokens_type='performer', in_chans=3, embed_dim=768, token_dim=64):
        super().__init__()
...
class T2T_ViT(nn.Module):
    def __init__(self, img_size=[64,1024], tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
    ...
    def forward_features(self, x, temb):
        ...
        x = torch.cat((cls_tokens, x), dim=1) # B,257,384

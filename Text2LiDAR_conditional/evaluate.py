...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=Path, default='/project/r2dm-main/logs/diffusion/kitti_360/spherical-1024/transformer_400000/models/diffusion_0000400000.pth')
    parser.add_argument("--sample_dir", type=str, default='/project/r2dm-main/logs/diffusion/kitti_360/spherical-1024/transformer_400000/results')
